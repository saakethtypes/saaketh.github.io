...
export const SaakethCodes = () => {
  ...
  <div id="leftside-navigation" className="nano">
    <ul className="nano-content">
      ...
      <li className="sub-menu">
        <a href="javascript:void(0);"><i className="fa fa-map-marker"></i><span>Maps</span><i className="arrow fa fa-angle-right pull-right"></i></a>
        <ul>
      ...
      <li className="sub-menu">
        <a href="typography.html"><i className="fa fa-text-height"></i><span>Typography</span></a>
      </li>
      <li className="sub-menu">
        <a href="javascript:void(0);"><i className="fa fa-file"></i><span>Pages</span><i className="arrow fa fa-angle-right pull-right"></i></a>
        <ul>
